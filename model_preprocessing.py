...
import_path = Path(Path.cwd(), 'raw_data.csv')
...
X_train_output_path = Path(Path.cwd(), 'X_train.txt')
...
X_test_output_path = Path(Path.cwd(), 'X_test.txt')
...
Y_train_output_path = Path(Path.cwd(), 'Y_train.txt')
...
Y_test_output_path = Path(Path.cwd(), 'Y_test.txt')
